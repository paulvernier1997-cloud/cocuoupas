...
const articles = [
  { slug: "8-signes-partenaire-trompe", title: "8 Signes Révélateurs que Votre Partenaire Vous Trompe", excerpt: "Le doute est un poison insidieux. Avant de confronter sans preuves, apprenez à décrypter les signaux numériques et comportementaux qui trahissent une double vie.", date: "13 mai 2025", readTime: "7 min", tag: "Détection", featured: true },
  { slug: "guide-complet-tinder-2025", title: "Guide complet Tinder 2025 : fonctionnement, algorithme et profils", excerpt: "Tout ce qu'il faut savoir sur Tinder : comment les profils sont affichés, comment fonctionne le matching, et comment détecter un compte actif.", date: "11 mai 2025", readTime: "10 min", tag: "Tinder", featured: false },
